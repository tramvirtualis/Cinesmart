...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    boolean existsByVouchersVoucherId(Long voucherId);

    @Modifying
    @Transactional
    @Query(value = "DELETE FROM customer_vouchers WHERE voucher_id = :voucherId", nativeQuery = true)
    void unassignVoucherFromAllCustomers(@Param("voucherId") Long voucherId);
}